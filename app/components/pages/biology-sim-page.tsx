...
import { questions_unit_1 } from "@/lib/biology-questions";
import { questions_unit_2 } from "@/lib/biology-questions";
import { questions_unit_3 } from "@/lib/biology-questions";
import { questions_unit_4 } from "@/lib/biology-questions";
import { questions_unit_5 } from "@/lib/biology-questions";
import { questions_unit_6 } from "@/lib/biology-questions";
import { questions_unit_7 } from "@/lib/biology-questions";
import { questions_unit_8 } from "@/lib/biology-questions";
import { questions_unit_9 } from "@/lib/biology-questions";
import { questions_unit_10 } from "@/lib/biology-questions";

export default function BiologySimPage() {
  const cards = [
    {
      title: "الباب الأول: الجهازان الهيكلي والعضلي",
      href: "/biology-sim/unit-1",
      count: questions_unit_1.length,
    ...
    },
    {
      ...
      count: questions_unit_10.length,
      badges: ["ثاني ثانوي", "أحياء", "عبدالخالق جبره"],
